...
const RecipeForm = ({register,handleSubmit,errors,onSubmit,reset}) => {
  return (
     <div className='flex justify-center items-center h-[80vh]'>
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-y-5 w-full max-w-lg bg-gray-700 p-8 rounded-2xl shadow-xl'>
                <h1 className='text-3xl font-semibold mb-2'>Create a Recipe</h1>
                ...
                <button className='bg-red-500 text-white font-semibold py-3 rounded-lg hover:bg-red-600 transition-colors active:scale-95 duration-150 mt-2' type="submit">Create Recipe</button>
            </form>
        </div>
